...
import "./trend.css"; // Ensure you have appropriate styles
  ...
  return (
    <>
      <div className="trending-section-wrapper">
        <div className="headd">
          <div className="trh">
            <div className="trhh">Trending</div>
          </div>
          <div className="flex righto">
            {/* <div className="all">
            <div className="traa">All</div>
          </div> */}
            <div className="trendi-swiper-navigation">
              <div className="btn-pre swipe-controls">
                <FaChevronLeft size={15} />
              </div>
              <div className="btn-nex swipe-controls">
        ...
        <div className="tendi">
                ...
                >
                  ...
                  <div className="trending-slide-details">
                    <Link href={slide.id} className="trending-slide-link">
                      <span className="trending-slide-title">
                        {slide.title}
                      </span>
                    </Link>
          ...
          <div className="navitr">
            <div className="trending-swiper-navigation">
              <div className="btn-nex swiper-controls">
                <FaChevronRight size={20} />
              </div>
              <div className="btn-pre swiper-controls">
